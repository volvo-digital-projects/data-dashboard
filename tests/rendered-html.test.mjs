...
test("locks page 2 zoom and fits the iPad 13-inch landscape viewport", async () => {
  ...
  assert.match(css, /@media \(hover: none\) and \(pointer: coarse\) and \(orientation: landscape\) and \(min-width: 761px\) and \(max-width: 1400px\)\s*\{[\s\S]*?\.competitive-analysis-page \.growth-navigation-workspace,[\s\S]*?100dvh - var\(--growth-navigation-sticky-top, 122px\) -[\s\S]*?var\(--growth-navigation-summary-height, 152px\) - 36px[\s\S]*?\.competitive-analysis-page \.growth-position-card,[\s\S]*?height: 216px;[\s\S]*?\.competitive-analysis-page \.growth-zone-gauge\s*\{[\s\S]*?width: min\(100%, 350px\);[\s\S]*?\.competitive-analysis-page \.growth-sales-stage\s*\{[\s\S]*?height: 88px;[\s\S]*?\.competitive-analysis-page \.growth-evidence-grid\s*\{[\s\S]*?height: 188px;[\s\S]*?padding-top: 0;[\s\S]*?\.competitive-analysis-page \.growth-sales-monthly-card\s*\{[\s\S]*?height: 188px;[\s\S]*?min-height: 188px;/);
  ...
  assert.match(css, /@media \(hover: none\) and \(pointer: coarse\) and \(orientation: landscape\) and \(min-width: 761px\) and \(max-width: 1400px\)\s*\{[\s\S]*?\.competitive-analysis-page \.growth-scatter-card > header > :first-child\s*\{[^}]*transform: translateX\(-7px\);[\s\S]*?\.competitive-analysis-page \.growth-comment-evidence > header > :first-child\s*\{[^}]*transform: translateX\(-3px\);[\s\S]*?\.competitive-analysis-page \.growth-sales-funnel-card > header > :first-child,[\s\S]*?\.competitive-analysis-page \.growth-sales-monthly-card > header > :first-child\s*\{[^}]*transform: translateX\(-1px\);/);
  ...
  assert.match(css, /@media \(hover: none\) and \(pointer: coarse\) and \(orientation: landscape\) and \(min-width: 761px\) and \(max-width: 1400px\)\s*\{[\s\S]*?\.competitive-analysis-page \.growth-comment-bar-column\s*\{[^}]*gap: 3px;[\s\S]*?\.competitive-analysis-page \.growth-comment-bar > i\s*\{[^}]*height: 10px;[\s\S]*?\.competitive-analysis-page \.growth-sales-month\s*\{[^}]*min-height: 86px;[^}]*grid-template-rows: 14px 1fr 16px;[\s\S]*?\.competitive-analysis-page \.growth-sales-month > i\s*\{[^}]*min-height: 48px;[\s\S]*?\.competitive-analysis-page \.growth-sales-monthly-legend\s*\{[^}]*min-height: 18px;[^}]*padding-top: 1px;/);
